...
fields:
  ...
  <div class="docs-gallery more-margin-top inline-block">
    <a data-fancybox="gallery-3" href="/docs/monitoring/images/my_custom_metrics.png"><img class="img-responsive img-wellcome" src="/docs/monitoring/images/my_custom_metrics.png"/></a>
  </div>
