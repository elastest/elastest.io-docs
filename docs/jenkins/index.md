...
*   Select the **Advanced** tab and scroll to top. Fill the gap **Update Site** `https://updates.jenkins.io/experimental/update-center.json`
...
<div class="docs-gallery inline-block">
    <a data-fancybox="gallery-3" href="/docs/jenkins/images/plugin_install.png"><img class="img-responsive img-wellcome" src="/docs/jenkins/images/plugin_install2.png"/></a>
</div>
